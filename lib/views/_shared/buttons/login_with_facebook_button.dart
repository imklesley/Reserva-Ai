...
class LoginWithFacebookButton extends StatelessWidget {
  ...
  const LoginWithFacebookButton({Key? key, required this.formContext}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Tooltip(
      ...
      child: ElevatedButton(
        ...
        onPressed: () {
          _auth.signInSignUpWithFacebook(onSuccess: onSuccess, onFail: onFail);
        },
        child: SizedBox(
          height: 50,
          child: SvgPicture.asset('assets/images/icons/facebook_logo.svg',
